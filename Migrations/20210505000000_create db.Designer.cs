...
namespace BP_Webshop.Migrations
{
    ...
    [Migration("20210505000000_create db")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BP_Webshop.Models.Order", b =>
                {
                    b.HasOne("BP_Webshop.Models.User", "Id")
                        .WithMany()
                        .HasForeignKey("Id1");
            ...
            modelBuilder.Entity("BP_Webshop.Models.OrderLine", b =>
                {
                    b.HasOne("BP_Webshop.Models.Jewelry", "JewelryId")
                        .WithMany()
                        .HasForeignKey("JewelryID");

                    b.HasOne("BP_Webshop.Models.Order", "OrderId")
                        .WithMany()
                        .HasForeignKey("OrderId1");

                    b.Navigation("JewelryId");
